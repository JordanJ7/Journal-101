      ...
      {modalState?.isOpen && (
        ...
        >
          <div
            ...
            className="w-full max-w-md bg-white dark:bg-stone-900 rounded-2xl shadow-2xl border border-stone-200 dark:border-stone-800 p-6 space-y-5 animate-in zoom-in-95 duration-150"
