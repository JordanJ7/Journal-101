...
export const AccessManagementModal: React.FC<AccessManagementModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex items-end sm:items-center justify-center p-0 sm:p-4 overflow-y-auto animate-in fade-in duration-150"
      onClick={(e) => {
