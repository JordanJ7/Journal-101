  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed top-16 right-0 bottom-0 z-40 w-full max-w-sm sm:w-96 bg-white/95 dark:bg-stone-900/95 backdrop-blur-md border-l border-stone-200 dark:border-stone-800 shadow-2xl flex flex-col transition-transform duration-300 ease-in-out ${
