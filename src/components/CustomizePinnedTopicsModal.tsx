...
export const CustomizePinnedTopicsModal: React.FC<CustomizePinnedTopicsModalProps> = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4 animate-in fade-in duration-150 transform-gpu will-change-transform isolate"
    >
      <div
